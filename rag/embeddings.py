...
logger = setup_logger("aios.rag.embeddings")


class RAGEmbeddings(ABC):
    @abstractmethod
...
class SentenceTransformerRAGEmbeddings(RAGEmbeddings):
    def __init__(
        self,
        ...
        self._logger = setup_logger("aios.rag.embeddings.sentence")
    ...
    def _lazy_load(self) -> None:
        ...
        try:
            ...
            self._logger.warning("sentence-transformers not installed; using fallback")
            self._dim = 384
